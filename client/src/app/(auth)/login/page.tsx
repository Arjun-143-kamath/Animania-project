    ...
    <div className="flex flex-1 items-center justify-center p-4">
      <div className="w-full max-w-md rounded-2xl bg-card p-10 border border-border shadow-2xl">
        <div className="mb-8 text-center">
          ...
          <p className="text-muted-foreground">Log in to manage your anime library</p>
        </div>
        ...
        <div className="mt-6 grid grid-cols-2 gap-3">
          <a
            ...
            className="flex items-center justify-center gap-2 w-full p-3 bg-card border border-border rounded-lg text-sm font-semibold hover:bg-muted transition-colors"
          >
